...
export default function Login() {
  ...
  return (
    <div className="min-h-screen grid place-items-center bg-gray-900 text-gray-100">
      <form onSubmit={submit} className="w-full max-w-sm bg-gray-800 border border-gray-700 rounded-2xl p-6 shadow-lg">
        <h1 className="text-xl font-semibold mb-4 text-gray-100">{registro ? 'Registrar usuario' : 'Iniciar sesión'}</h1>
        <div className="space-y-3">
          ...
          {registro && (
            <>
              ...
              />
              <select
                className="w-full border border-gray-600 rounded-lg px-3 py-2 bg-gray-700 text-gray-100 focus:border-blue-500 focus:outline-none"
                value={rol}
          ...
          <button className="w-full bg-blue-600 hover:bg-blue-700 text-white rounded-lg px-3 py-2 transition-colors">
            {registro ? 'Registrar' : 'Entrar'}
          </button>
          <button
            type="button"
            className="w-full text-xs text-blue-400 underline mt-2 hover:text-blue-300"
